...
import { 
// googleVerify,
login, logout, signup, verifyToken, existingUser, getPartnerData, updatePartner, updatePartnerProfilePic, forgotPassword, verifyPasswordOTP, setNewPassword, kycUpdate, kycDocumentUpload, addSlot, getSlot, editSlot, } from "../controller/partnerController.js";
...
partnerRoute.patch("/updatepartnerprofilepic", verifyToken, upload.single("image"), updatePartnerProfilePic);
